...
const mockWatchlist = [
  {
    id: 157336,
    title: "Interestelar",
    overview: "Un grupo de exploradores hace uso de un agujero de gusano recientemente descubierto para superar las limitaciones de los viajes espaciales tripulados.",
  ...
  },
  {
    id: 60735,
    title: "The Flash",
    overview: "Después de ser alcanzado por un rayo, Barry Allen despierta de un coma de nueve meses para descubrir que ha sido dotado del poder de la súper velocidad.",
  ...
  },
  {
    ...
    overview: "Después de las historias de Jango y Boba Fett, emerge otro guerrero en la galaxia. The Mandalorian está ambientado después de la caída del Imperio.",
  ...
  },
  {
    id: 603,
    title: "Matrix",
    overview: "Un programador es llevado a un submundo de rebelión donde descubre que su realidad es una simulación por computadora controlada por máquinas cibernéticas.",
