		...
		>
			<div
				className={clsx(
					...
					isActive
						? 'py-3.5 bg-[#0DE383] rounded-lg h-14'
						: 'py-2 bg-transparent h-auto',
					{ 'cursor-pointer': !isActive }
				)}
			>
				<div className={isActive ? 'text-[#121212]' : 'text-[#A1A1AA]'}>
					{icon}
				</div>
				<div
					className={clsx(
						'text-sm font-medium font-[var(--font-inter)] leading-5 whitespace-nowrap h-auto inline-block',
	...
	return (
		<div className="navbar-container w-full fixed top-0 h-20 flex items-center justify-center backdrop-blur-md bg-[rgba(18,18,18,0.7)] z-[1000]">
			<div className="navbar-inner w-full px-2 sm:px-4 md:px-6 lg:px-8 max-w-screen-3xl flex justify-between items-center">
				...
				<div className="user-avatar w-8 h-8 overflow-hidden rounded-full inline-flex relative">
					<Image
